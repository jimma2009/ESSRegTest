...
public class ESSRegTestB_Team {
    ...
    public void testB10071_StepsPreAddTeamsAndMembers() throws IOException, InterruptedException, Exception {
        ...
        //////////////// Temp disable edit Steve Barry Preferred name ///////////////
    ...
    public void testB10101_AddTeamsAndMembers_3() throws IOException, InterruptedException, Exception {
        ...
        logMessage("Item B7.4.30: Step 66 - Row 192. Add Members into Team This Team I.", testSerialNo);
    ...
    public static void testB10191_ValidteJenniferHTeamPage() throws Exception {
        ...
        WebDriver driver = GeneralBasic.launchESS(url_ESS, SystemLibrary.driverType);
        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
        myAssert.assertEquals(GeneralBasicHigh.logonESSMain(10101, 10101, payrollDBName, testSerialNo, emailDomainName, url_ESS, driver), true, "Failed in Item B10.15: Logon as Jennifer H.");
    ...
    /*
    @Test(priority = 10202)
    public void testB10202_AddTeamsAndMembers() throws IOException, InterruptedException, Exception {
        ESSSoftAssert myAssert = new ESSSoftAssert();
        if (testSerialNo==null) testSerialNo=getCurrentTestSerialNumber(moduleNo, moduleName);

        logMessage("*** Start Test B10202: Add Teams and Members.");
        WebDriver driver = GeneralBasic.launchESS(url_ESS, SystemLibrary.driverType);
        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
        GeneralBasicHigh.logonESSMain(101, 101, payrollDBName, testSerialNo, emailDomainName, url_ESS, driver);

        logMessage("Item B10.22.1: Add multi Members into Teams.", testSerialNo);
        myAssert.assertEquals(GeneralBasicHigh.addMultiTeam(31323, 31333, driver), true, "");
        myAssert.assertEquals(GeneralBasicHigh.addTeamMember_Main(31449, 31482, testSerialNo, driver), true, "Failed in Item B10.22.1: Add multi Members into Teams.");

        GeneralBasic.signoutESS(driver);
        driver.close();
        logMessage("*** End of Test B10202: Add Teams and Members.");
        myAssert.assertAll();
    }
    ...
    public void testB10202_AddTeamsAndMembers() throws IOException, InterruptedException, Exception {
        ...
        logMessage("Item B10.22.1: Add multi Members into Teams.", testSerialNo);
        myAssert.assertEquals(GeneralBasicHigh.addMultiTeam(31323, 31333, driver), true, "");
        myAssert.assertEquals(GeneralBasicHigh.addTeamMember_Main(31449, 31458, testSerialNo, driver), true, "Failed in Item B10.22.1: Add multi Members into Teams.");
    ...
    @Test(priority = 10203)
    public void testB10203_AddTeamsAndMembers() throws IOException, InterruptedException, Exception {
        ESSSoftAssert myAssert = new ESSSoftAssert();
        if (testSerialNo==null) testSerialNo=getCurrentTestSerialNumber(moduleNo, moduleName);

        logMessage("*** Start Test B10203: Add Teams and Members.");
        WebDriver driver = GeneralBasic.launchESS(url_ESS, SystemLibrary.driverType);
        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
        GeneralBasicHigh.logonESSMain(101, 101, payrollDBName, testSerialNo, emailDomainName, url_ESS, driver);

        myAssert.assertEquals(GeneralBasicHigh.addTeamMember_Main(31459, 31468, testSerialNo, driver), true, "Failed in Item B10.22.1: Add multi Members into Teams.");

        GeneralBasic.signoutESS(driver);
        driver.close();
        logMessage("*** End of Test B10203: Add Teams and Members.");
        myAssert.assertAll();
    }


    @Test(priority = 10204)
    public void testB10204_AddTeamsAndMembers() throws IOException, InterruptedException, Exception {
        ESSSoftAssert myAssert = new ESSSoftAssert();
        if (testSerialNo==null) testSerialNo=getCurrentTestSerialNumber(moduleNo, moduleName);

        logMessage("*** Start Test B10204: Add Teams and Members.");
        WebDriver driver = GeneralBasic.launchESS(url_ESS, SystemLibrary.driverType);
        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
        GeneralBasicHigh.logonESSMain(101, 101, payrollDBName, testSerialNo, emailDomainName, url_ESS, driver);

        myAssert.assertEquals(GeneralBasicHigh.addTeamMember_Main(31469, 31478, testSerialNo, driver), true, "Failed in Item B10.22.1: Add multi Members into Teams.");

        GeneralBasic.signoutESS(driver);
        driver.close();
        logMessage("*** End of Test B10204: Add Teams and Members.");
        myAssert.assertAll();
    }

    @Test(priority = 10205)
    public void testB10205_AddTeamsAndMembers() throws IOException, InterruptedException, Exception {
        ESSSoftAssert myAssert = new ESSSoftAssert();
        if (testSerialNo==null) testSerialNo=getCurrentTestSerialNumber(moduleNo, moduleName);

        logMessage("*** Start Test B10205: Add Teams and Members.");
        WebDriver driver = GeneralBasic.launchESS(url_ESS, SystemLibrary.driverType);
        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
        GeneralBasicHigh.logonESSMain(101, 101, payrollDBName, testSerialNo, emailDomainName, url_ESS, driver);

        myAssert.assertEquals(GeneralBasicHigh.addTeamMember_Main(31479, 31482, testSerialNo, driver), true, "Failed in Item B10.22.1: Add multi Members into Teams.");

        GeneralBasic.signoutESS(driver);
        driver.close();
        logMessage("*** End of Test B10205: Add Teams and Members.");
        myAssert.assertAll();
    }
    ...
    */
    ...
    public static void testB10241_LogonESSAsTeamMemberAndValidateTeamPage() throws Exception {
        ...
        WebDriver driver = GeneralBasic.launchESS(url_ESS, SystemLibrary.driverType);
        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
        myAssert.assertEquals(logonESSMain(561, 561, payrollDBName, testSerialNo, emailDomainName, url_ESS, driver), true, "Failed in Item B11.04: Log on ESS as Peter KONG.");
    ...
    /*
       ///// No need import Team and Team members/////////////////
        @Test(priority = 10342)
        public void testH10342_AddTeamsAndMembers() throws IOException, InterruptedException, Exception {
            ESSSoftAssert myAssert = new ESSSoftAssert();
            if (testSerialNo==null) testSerialNo=getCurrentTestSerialNumber(moduleNo, moduleName);

            logMessage("*** Start Test H10342: Add Teams and Members.");
            WebDriver driver = GeneralBasic.launchESS(url_ESS, SystemLibrary.driverType);
            driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
            GeneralBasicHigh.logonESSMain(101, 101, payrollDBName, testSerialNo, emailDomainName, url_ESS, driver);

            logMessage("Item B20.1.X.1: Add multi Members into Teams.", testSerialNo);
            myAssert.assertEquals(GeneralBasicHigh.addMultiTeam(31311, 31333, driver), true, "");
            myAssert.assertEquals(GeneralBasicHigh.addTeamMember_Main(31411, 31482, testSerialNo, driver), true, "Failed in Item B20.1.X.1: Add multi Members into Teams.");

            logMessage("*** End of Test H10342: Add Teams and Members.");
            myAssert.assertAll();
        }
    */
